...
import casa from '../../assets/imagens/casa.png';
import massa1 from '../../assets/imagens/massa1.png';
import massa2 from '../../assets/imagens/massa2.png';
      ...
      <div className={styles.imagens}>
        {imagens.map((imagem, index) => (
          <div key={index} className={styles.imagens__imagem}>
            <img  src={imagem} alt='massa aluroni'/>
          </div>
        ))}
      </div>
